...
@funix(
    ...
    input_layout=[
        ...
        [{"markdown": "申请项目总投资"}],
        [
            {"argument": "request_equipment_purchase_fee"},
            {"argument": "request_energy_material_fee"},
        ],
        [
            {"argument": "request_trial_outsourcing_fee"},
            {"argument": "request_material_printing_fee"},
        ],
        [
            {"argument": "request_conference_research_fee"},
            {"argument": "request_rental_fee"},
        ],
        [
            {"argument": "request_appraisal_inspection_fee"},
            {"argument": "request_personnel_costs"},
        ],
        [{"argument": "request_management_fee"}, {"argument": "request_other_fee"}],
        [{"markdown": "已完成项目投资额"}],
        [
            {"argument": "completed_equipment_purchase_fee"},
            {"argument": "completed_energy_material_fee"},
        ],
        [
            {"argument": "completed_trial_outsourcing_fee"},
            {"argument": "completed_material_printing_fee"},
        ],
        [
            {"argument": "completed_conference_research_fee"},
            {"argument": "completed_rental_fee"},
        ],
        [
            {"argument": "completed_appraisal_inspection_fee"},
            {"argument": "completed_personnel_costs"},
        ],
...
def project_industry(
    ...
    return {
        ...
        "申请项目总投资": request_equipment_purchase_fee
        + request_energy_material_fee
        + request_trial_outsourcing_fee
        + request_material_printing_fee
        + request_conference_research_fee
        ...
        + request_management_fee
        + request_other_fee,
        "已完成项目投资额": completed_equipment_purchase_fee
        + completed_energy_material_fee
        + completed_trial_outsourcing_fee
        + completed_material_printing_fee
        + completed_conference_research_fee
